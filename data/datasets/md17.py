...
# def download_md17(root='tmp/md17'):
#     # call to download and parse md17 dataset
#     mol_file_dict = MD17.molecule_files
#     for k, f in mol_file_dict.items():
#         print(f'parsing {k}')
#         md17_dataset = MD17(root=root, dataset_arg=k)
#         print(f"Dataset for {k}: {md17_dataset}")