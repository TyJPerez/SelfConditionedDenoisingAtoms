...
#SBATCH -J scd-n004_geom01_4n
#SBATCH --account=m5068_g          # m5068_g or  m4866
...
job_id=scd-n004_geom01_b48n4 #currently running as scdSs-n004_pcq
conf=configs/scd_pretrain_geom1.yaml
