...
job_id=cet-sair_b12n2_0 # effective batch size 12*4*2 = 96
conf=configs/scd-sair_pretrain.yaml


max_epochs_per_run=40 # 40 is reasonable for 35 hours
